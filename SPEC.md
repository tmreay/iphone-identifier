...
- How the built app is served at the shop — copied to each device, or served
  from one machine on the LAN. **Partly settled by D-22**: on a bench PC it is
