...
**Every model has exactly one size class** (D-31). The class is a fact about the
...
Redrawing the bands onto the gaps (D-30) removed the need for the hedge, and
D-31 removed the hedge. The two go together: dual membership was only ever
...
every model one class anyway, so D-31 removes a mechanism that has nothing left
...
check over 288, and D-30 took it to 226 by cutting eight models from two size classes to
...
§6.3 gained the 3 mm adjacency rule (since removed by D-31), §9 replaced guesswork with
...
| D-10 | Size is expressed as body-size classes, never as measurements. The count was five until D-30 cut it to three, and the overlap this decision allowed was removed by D-31.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
