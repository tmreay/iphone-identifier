...
| `body_size_class`    | `standard`                                   | ✅ verified | S1     | Derived from body height 147.5 mm against the bands in SPEC.md §6.3. The three bands sit in the gaps between the clusters the bodies form, and every model carries exactly one class (SPEC.md §6.3, D-27, D-28).                                |
