...
| `body_size_class` | `standard` · `large` | ✅ verified | S1 | Derived from body height 147.5 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
![iPhone 14 Pro](../images/iphone-14-pro-and-pro-max.png)
