...
**Model id:** `iphone-14-pro` · **Released:** 2022 · **Generation:** 2022
...
| `body_size_class`    | `standard`                                   | ✅ verified | S1     | Derived from body height 147.5 mm against the bands in SPEC.md §6.3. The three bands sit in the gaps between the clusters the bodies form, and an adjacent class is added only when a model actually in that class sits within 3 mm — on the current set nothing does, so this is one class (SPEC.md §6.3, D-27). |
...
- **S1** — Apple — iPhone 14 Pro Tech Specs — <https://support.apple.com/en-us/111849> (fetched 2026-08-19)
- **S2** — Apple — Remove or switch the SIM card in your iPhone — <https://support.apple.com/en-us/109357> (fetched 2026-08-19)
- **S3** — Apple product image, committed as reference/images/apple/iphone-14-pro.jpg — <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-14-pro-finish-select-202209-6-1inch-spaceblack?wid=1800&hei=1800&fmt=jpeg&qlt=95> (fetched 2026-08-19)
...
![iPhone 14 Pro](../images/apple/iphone-14-pro.jpg)

`reference/images/apple/iphone-14-pro.jpg` — Apple's own product shot: one device, back and
front, straight on and unobstructed at 508x616. From <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-14-pro-finish-select-202209-6-1inch-spaceblack?wid=1800&hei=1800&fmt=jpeg&qlt=95>
