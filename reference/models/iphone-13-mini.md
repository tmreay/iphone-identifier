...
| `body_size_class` | `mini` | ✅ verified | S1 | Derived from body height 131.5 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
- **S3** — Apple product image, committed as reference/images/iphone-13-mini.png — <https://cdsassets.apple.com/live/SZLF0YNV/images/sp/111872_iphone13-mini-colors-480.png> (fetched 2026-08-19)
...
`reference/images/iphone-13-mini.png` — official Apple product image, from <https://cdsassets.apple.com/live/SZLF0YNV/images/sp/111872_iphone13-mini-colors-480.png> (downloaded 2026-08-19). Shows the rear in every finish plus the front.
