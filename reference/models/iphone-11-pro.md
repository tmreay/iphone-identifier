...
| `body_size_class` | `standard` | ✅ verified | S1 | Derived from body height 144.0 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
- **S4** — Apple product image, committed as reference/images/iphone-11-pro.png — <https://cdsassets.apple.com/live/SZLF0YNV/images/sp/111878_sp805-iphone11pro.png> (fetched 2026-08-19)
...
![iPhone 11 Pro](../images/iphone-11-pro.png)

`reference/images/iphone-11-pro.png` — official Apple product image, from <https://cdsassets.apple.com/live/SZLF0YNV/images/sp/111878_sp805-iphone11pro.png> (downloaded 2026-08-19). Shows the rear in every finish plus the front.
