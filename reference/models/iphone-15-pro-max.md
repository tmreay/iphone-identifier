...
| `body_size_class` | `max` | ✅ verified | S1 | Derived from body height 159.9 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
- **S3** — Apple product image, committed as reference/images/iphone-15-pro-max.png — <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/iphone-15-pro-max.png> (fetched 2026-08-19)
...
`reference/images/iphone-15-pro-max.png` — official Apple product image, from <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/iphone-15-pro-max.png> (downloaded 2026-08-19). Shows the rear in every finish plus the front.
