...
| `body_size_class` | `standard` · `large` | ✅ verified | S1 | Derived from body height 150.0 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
![iPhone 17 Pro](../images/iphone-17-pro-and-pro-max.png)
