...
| `flash_position` | `outside_bump_right` | ✅ verified | S3 | Outside the camera pill, on the back glass to its right. Read off the committed reference image during Phase 1. |
...
- In **black or white** this model is indistinguishable from the iPhone 17 on every attribute the spec defines — same camera layout, cutout, port, buttons, frame and back. The only real differences are 2 mm of body height and a 6.1-inch versus 6.3-inch display, both below what a technician can judge by eye. The other colours do separate them (16: Pink, Teal, Ultramarine; 17: Mist Blue, Sage, Lavender). See reference/findings.md §2.
...
- **S3** — Apple product image, committed as reference/images/iphone-16-and-16-plus.png — <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/iphone-16.png> (fetched 2026-08-19)
...
![iPhone 16](../images/iphone-16-and-16-plus.png)

`reference/images/iphone-16-and-16-plus.png` — official Apple product image, from <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/iphone-16.png> (downloaded 2026-08-19). Shows the rear in every finish plus the front.
