...
**Model id:** `iphone-15-plus` · **Released:** 2023 · **Generation:** 2023
...
| Apple's material description | Aluminum design, Ceramic Shield front, Color-infused glass back | S1     |
...
| `body_size_class`    | `large`                                                    | ✅ verified | S1     | Derived from body height 160.9 mm against the bands in SPEC.md §6.3. The three bands sit in the gaps between the clusters the bodies form, and an adjacent class is added only when a model actually in that class sits within 3 mm — on the current set nothing does, so this is one class (SPEC.md §6.3, D-27). |
...
| `colour`             | `black` · `light_blue` · `light_green` · `yellow` · `pink` | 🟡 inferred | S1     | Marketing names are Apple's; the descriptive mapping is this project's (see `reference/palette.md`).                                                                                                                                                                                                              |
...
| `camera_bump_size`        | `larger`                        | ✅ verified   | S3     | Compared within the diagonal-dual family. Measured off the committed product shots with each body normalised to the same width: the 14 and 15 generations carry a visibly wider plateau and larger lens elements than the 13 generation at equal body width.                                                                                                                                                                         |
...
- **S1** — Apple — iPhone 15 Plus Tech Specs — <https://support.apple.com/en-us/111830> (fetched 2026-08-19)
- **S2** — Apple — Remove or switch the SIM card in your iPhone — <https://support.apple.com/en-us/109357> (fetched 2026-08-19)
- **S3** — Apple product image, committed as reference/images/apple/iphone-15-plus.jpg — <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-plus-black-select-202309?wid=1800&hei=1800&fmt=jpeg&qlt=95> (fetched 2026-08-19)
...
- **S6** — wccftech — iPhone 14 Pro Max Camera Bump Compared With iPhone 13 Pro Max — <https://wccftech.com/iphone-14-pro-max-vs-iphone-13-pro-max-camera-bump-comparison/> (fetched 2026-08-19)

## Reference images

![iPhone 15 Plus](../images/apple/iphone-15-plus.jpg)

`reference/images/apple/iphone-15-plus.jpg` — Apple's own product shot: one device, back and
front, straight on and unobstructed at 1176x1556. From <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-15-plus-black-select-202309?wid=1800&hei=1800&fmt=jpeg&qlt=95>
