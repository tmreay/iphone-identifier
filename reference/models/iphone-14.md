...
**Model id:** `iphone-14` · **Released:** 2022 · **Generation:** 2022
...
| `body_size_class`    | `standard`                                                            | ✅ verified | S1     | Derived from body height 146.7 mm against the bands in SPEC.md §6.3. The three bands sit in the gaps between the clusters the bodies form, and an adjacent class is added only when a model actually in that class sits within 3 mm — on the current set nothing does, so this is one class (SPEC.md §6.3, D-27). |
...
- **S1** — Apple — iPhone 14 Tech Specs — <https://support.apple.com/en-us/111850> (fetched 2026-08-19)
- **S2** — Apple — Remove or switch the SIM card in your iPhone — <https://support.apple.com/en-us/109357> (fetched 2026-08-19)
- **S3** — Apple product image, committed as reference/images/apple/iphone-14.jpg — <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-14-midnight-select-202209?wid=1800&hei=1800&fmt=jpeg&qlt=95> (fetched 2026-08-19)
...
`reference/images/apple/iphone-14.jpg` — Apple's own product shot: one device, back and
front, straight on and unobstructed at 1090x1428. From <https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-14-midnight-select-202209?wid=1800&hei=1800&fmt=jpeg&qlt=95>
