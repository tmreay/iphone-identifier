...
| `body_size_class` | `max` | ✅ verified | S1 | Derived from body height 163 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see reference/findings.md §5. |
...
- **S3** — Apple product image, committed as reference/images/iphone-16-pro-and-pro-max.png — <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/121032-iphone-16-pro-max.png> (fetched 2026-08-19)
...
![iPhone 16 Pro Max](../images/iphone-16-pro-and-pro-max.png)

`reference/images/iphone-16-pro-and-pro-max.png` — official Apple product image, from <https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/121032-iphone-16-pro-max.png> (downloaded 2026-08-19). Shows the rear in every finish plus the front.
