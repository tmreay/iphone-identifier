...
| `body_size_class`    | `standard`                             | ✅ verified | S1     | Derived from body height 146.6 mm against the bands in SPEC.md §6.3. An adjacent class is added only when a model actually in that class sits within 3 mm — see SPEC.md §6.3.                                                                   |
