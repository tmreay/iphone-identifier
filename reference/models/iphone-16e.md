...
| `magsafe`                 | `absent`                        | ✅ verified       | S1     | No MagSafe. Apple's tech specs list only "Wireless charging (works with Qi chargers)" — no magnet array, unlike the otherwise identical iPhone 17e. **This is the iPhone 16e / 17e tiebreaker** (SPEC.md §4.4): a magnetic accessory holds on a 17e and not on a 16e, and works on a phone that will not power on.                                                                                                                   |
